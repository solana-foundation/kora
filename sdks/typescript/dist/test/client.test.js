...
import { createKeyPairSignerFromBytes, getBase58Encoder, getBase64EncodedWireTransaction, getBase64Encoder, getTransactionDecoder, signTransaction, } from "@solana/kit";
...
async function loadKeypairSignerFromEnvironmentBase58(envVar) {
...
describe("KoraClient Integration Tests", () => {
    ...
    beforeAll(async () => {
        ...
        signer = await loadKeypairSignerFromEnvironmentBase58("TEST_WALLET_PRIVATE_KEY");
    });
    ...
    describe("Error Handling", () => {
        ...
        it("should handle invalid transaction for fee estimation", async () => {
            await expect(client.estimateTransactionFee("invalid_transaction", usdcMint)).rejects.toThrow();
        });
