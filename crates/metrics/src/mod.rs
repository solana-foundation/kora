use crate::{handler::MetricsHandlerLayer, middleware::HttpMetricsLayer};
use jsonrpsee::{
    server::{ServerBuilder, ServerHandle},
    RpcModule,
};
use kora_lib::config::MetricsConfig;
...
pub mod middleware;
pub use middleware::HttpMetricsService;

// Export the metrics handler
pub mod handler;
pub use handler::MetricsHandlerService;
