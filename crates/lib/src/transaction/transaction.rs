...
pub async fn sign_transaction_if_paid(
    ...
    let min_transaction_fee =
        FeeConfigUtil::estimate_transaction_fee(rpc_client, resolved_transaction, Some(&fee_payer))
            .await?;
...
mod tests {
    ...
    mod tests {
        ...
        use crate::{
            ...
            transaction::decode_b64_transaction,
        };
        ...
        async fn test_estimate_transaction_fee_basic() {
            ...
            let fee = FeeConfigUtil::estimate_transaction_fee(&rpc_client, &transaction, None)
                .await
                .unwrap();
        ...
        async fn test_estimate_transaction_fee_invalid_transaction() {
            ...
            let result =
                FeeConfigUtil::estimate_transaction_fee(&rpc_client, &transaction, None).await;
